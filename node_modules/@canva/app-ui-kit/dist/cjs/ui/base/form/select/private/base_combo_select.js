...
const defaultFilterFn = (value, options)=>{
    ...
    return value ? options.filter((option)=>{
        var _option_value;
        const lowerCaseOption = `${(_option_value = option.value) !== null && _option_value !== void 0 ? _option_value : ''} ${option.label}`.toLocaleLowerCase();
    ...
    class BaseComboSelect extends (_React_Component = _react.Component) {
        ...
        constructor(...args){
            super(...args), this.presenter = (_BaseComboSelect._makeObservable(this), new BaseComboSelectPresenter()), this.store = new BaseComboSelectStore(), this.onInputChange = (value, e)=>{
                ...
                (_this_props_onChange = (_this_props = this.props).onChange) === null || _this_props_onChange === void 0 ? void 0 : _this_props_onChange.call(_this_props, value, e);
