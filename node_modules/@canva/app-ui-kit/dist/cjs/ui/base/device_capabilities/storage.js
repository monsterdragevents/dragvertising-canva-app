...
_export(exports, {
    get getLocalStorageIfAvailable () {
        return getLocalStorageIfAvailable;
    },
    get getSessionStorageIfAvailable () {
        return getSessionStorageIfAvailable;
    },
...
async function hasStorageAccess(document1 = globalDocument, window1 = globalWindow) {
...
function hasCookiesAccess(document1 = globalDocument) {
...
async function requestStorageAccess(document1 = globalDocument, window1 = globalWindow) {
...
function hasLocalStorageAccess(window1 = globalWindow) {
...
function getLocalStorageIfAvailable(window1 = globalWindow) {
    if (!window1 || !hasLocalStorageAccess(window1)) return;
    return window1.localStorage;
}
function getSessionStorageIfAvailable(window1 = globalWindow) {
