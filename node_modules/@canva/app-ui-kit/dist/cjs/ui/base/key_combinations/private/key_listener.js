...
class KeyListener {
    ...
    static isKeyMatch(event, trigger) {
        ...
        } else if (_key_map.KeyMap.shiftMap[trigger.key] != null && trigger.shiftKey) return specialChars.has(_key_map.KeyMap.shiftMap[trigger.key]) ? false : eventKey === _key_map.KeyMap.shiftMap[trigger.key];
        return false;
    }
