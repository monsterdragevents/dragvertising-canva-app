...
new (_class = class extends _identity {
    ...
    class DraggableView extends (_React_Component = _react.Component) {
        ...
        constructor(...args){
            super(...args), this.draggable = (_DraggableView._makeObservable(this), new _draggable.Draggable(new Proxy({}, {
