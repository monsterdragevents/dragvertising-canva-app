...
new (_class = class extends _identity {
    constructor(){
        super(_WindowedList), _initClass();
    }
}, (()=>{
    class WindowedList extends (_React_Component = React.Component) {
        ...
        constructor(...args){
            super(...args), this.visibleRange = (_WindowedList._makeObservable(this), undefined);
        }
    }
    ({ c: [_WindowedList, _initClass] } = _apply_decs_2203_r(WindowedList, [], [
        observerForClass
    ], _React_Component));
})(), _class)();
export { _WindowedList as WindowedList };
