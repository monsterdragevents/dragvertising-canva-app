...
export class PressRecognizer {
    ...
    onPointerMove(pointers, allPointers) {
        if (this.state && !this.isWithinMaxDistance()) {
            ...
            state.recognized && ((_this_opts_onCancel = (_this_opts = this.opts).onCancel) === null || _this_opts_onCancel === void 0 ? void 0 : _this_opts_onCancel.call(_this_opts, getCommonEventProperties(state.pointer.current)));
        }
    }
    onPointerUp(pointer) {
        if (this.state) {
            ...
            window.clearTimeout(state.timeoutId);
            this.clearEventListeners(state.pointer.start);
            if (state.recognized) withinMaxDistance ? (_this_opts_onEnd = (_this_opts = this.opts).onEnd) === null || _this_opts_onEnd === void 0 ? void 0 : _this_opts_onEnd.call(_this_opts, getCommonEventProperties(pointer.current)) : (_this_opts_onCancel = (_this_opts1 = this.opts).onCancel) === null || _this_opts_onCancel === void 0 ? void 0 : _this_opts_onCancel.call(_this_opts1, getCommonEventProperties(pointer.current));
        }
    }
    onUnmount() {
        var _this_state, _this_opts_onCancel, _this_opts;
        if ((_this_state = this.state) === null || _this_state === void 0 ? void 0 : _this_state.recognized) (_this_opts_onCancel = (_this_opts = this.opts).onCancel) === null || _this_opts_onCancel === void 0 ? void 0 : _this_opts_onCancel.call(_this_opts, getCommonEventProperties(this.state.pointer.current));
    }
    isWithinMaxDistance() {
    ...
    constructor(opts){
        ...
        this.timeout = ()=>{
            if (this.state) {
                ...
                (_this_opts_onStart = (_this_opts = this.opts).onStart) === null || _this_opts_onStart === void 0 ? void 0 : _this_opts_onStart.call(_this_opts, getCommonEventProperties(this.state.pointer.start));
            }
        };
