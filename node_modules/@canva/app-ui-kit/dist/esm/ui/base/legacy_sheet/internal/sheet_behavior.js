...
export class BottomSheetDragBehavior {
    ...
    onEventStart() {
        ...
        if (this.hasPeekState) Preconditions.checkArgument(this.midSize > 0, 'the peek height is not defined');
...
export function calculateNextStateImpl({ direction, deltaSize, velocity, hasPeekState, midSize, maxSize }) {
    let threshold = 0;
    switch(direction){
        case 'up':
        case 'right':
