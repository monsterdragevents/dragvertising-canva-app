...
export const InternalSheet = React.forwardRef((props, ref)=>{
    var _props_overlay;
    ...
    return _jsx(_InternalSheetClass, {
        ...props,
...
new (_class = class extends _identity {
    ...
    class InternalSheetClass extends (_React_Component = React.Component) {
    ...
    InternalSheetClass.ids = new IdGenerator('sheet__');
})(), _class)();
