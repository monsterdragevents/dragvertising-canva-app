...
export class Draggable {
    ...
    getDragCallbacks(dragType) {
        ...
        const processDragMove = ()=>{
            var _this_opts_onDragMove, _this_opts;
            const event = Preconditions.checkExists(pendingDragMove).event;
            (_this_opts_onDragMove = (_this_opts = this.opts).onDragMove) === null || _this_opts_onDragMove === void 0 ? void 0 : _this_opts_onDragMove.call(_this_opts, event);
        ...
        return {
            ...
            onDragMove: (e)=>{
                if (this.opts.unthrottleEvents) {
                    var _this_opts_onDragMove, _this_opts;
                    (_this_opts_onDragMove = (_this_opts = this.opts).onDragMove) === null || _this_opts_onDragMove === void 0 ? void 0 : _this_opts_onDragMove.call(_this_opts, e);
                    return;
                }
    ...
    constructor(opts) {
        ...
        this.onMouseDown = (e)=>{
            ...
            const holdToDrag = ((_this_opts_holdToDrag = this.opts.holdToDrag) === null || _this_opts_holdToDrag === void 0 ? void 0 : _this_opts_holdToDrag.enabled) === 'always' ? this.opts.holdToDrag.duration || 'default' : 'off';
            ...
            this.tracker = new MouseTracker(drag, simulateDragMove, this.onTrackerStopped, browserWindow);
        };
        this.onTouchStart = (e)=>{
            var _this_opts_holdToDrag, _this_opts_holdToDrag1;
            ...
            const holdToDrag = ((_this_opts_holdToDrag = this.opts.holdToDrag) === null || _this_opts_holdToDrag === void 0 ? void 0 : _this_opts_holdToDrag.enabled) === 'always' || ((_this_opts_holdToDrag1 = this.opts.holdToDrag) === null || _this_opts_holdToDrag1 === void 0 ? void 0 : _this_opts_holdToDrag1.enabled) === 'touch-only' ? this.opts.holdToDrag.duration || 'default' : 'off';
